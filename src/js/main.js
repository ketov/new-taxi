...
$(document).ready(function () {
    ...
    scrollTo('#blog-bus-link', '#blog-bus');
    scrollTo('#blog-tbus-link', '#blog-tbus');
    scrollTo('#blog-taxi-link', '#blog-taxi');
    scrollTo('#blog-car-link', '#blog-car');
    scrollTo('#blog-companion-link', '#blog-companion');
    scrollTo('#blog-train-link', '#blog-train');
    ...
    $('.suggestion-menu li').on('click', function(){
        ...
        input.removeClass('icon-plane');
        input.removeClass('icon-auto');
        input.removeClass('icon-city');
        input.removeClass('icon-landmarks');
        input.removeClass('icon-nature');
        input.removeClass('icon-other');
        input.removeClass('icon-hotel');
        input.removeClass('icon-train');
        input.addClass(c);
    });
    
    $('.input.with-hidden').on('change', function(){
        if($(this).val()==''){
            $(this).removeClass('icon-plane');
            $(this).removeClass('icon-auto');
            $(this).removeClass('icon-city');
            $(this).removeClass('icon-landmarks');
            $(this).removeClass('icon-nature');
            $(this).removeClass('icon-other');
            $(this).removeClass('icon-hotel');
            $(this).removeClass('icon-train');
        }
    });
